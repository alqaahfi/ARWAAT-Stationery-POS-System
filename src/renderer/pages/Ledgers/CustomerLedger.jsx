...
// Mounted at /ledgers/customers, with or without a customerId param — no id
// is picker mode (reached from the nav item), an id from a Customer List row
// click is preselected mode. Switching the picker's selection while already
// viewing a ledger just reloads for the newly picked customer, no navigating
// away.
